...
class Notifications extends React.PureComponent {
  ...
  render () {
    ...
    const emptyMessage = <FormattedMessage id='empty_column.notifications' defaultMessage="You don't have any notifications yet. To meet new people try 'pinning' the LOCAL TIMELINE as a new column!" />;
