...
export const links = [
  ...
  <NavLink className='tabs-bar__link primary' to='/timelines/public/local' data-preview-title-id='column.community' data-preview-icon='users' ><Icon id='users' fixedWidth /><FormattedMessage id='tabs_bar.local_timeline' defaultMessage='Local' /></NavLink>,	
  ...
  <NavLink className='tabs-bar__link primary' to='/timelines/direct' data-preview-title-id='column.direct' data-preview-icon='envelope' ><Icon id='envelope' fixedWidth /><FormattedMessage id='tabs_bar.direct' defaultMessage='Direct messages' /></NavLink>,
