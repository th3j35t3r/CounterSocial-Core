...
export default class StatusContent extends React.PureComponent {
  ...
  render () {
    ...
    //const thisvisibility = status.get('visibility');
    //let contentHtml;
   ...
   // }
    ...
    //status.get('content') = '<i class="fa fa-lock" aria-hidden="true"></i>&nbsp;' + status.get('content');
    ...
    if (thisvisibility == 'direct') {
      ...
      var thisstatus = status.get('contentHtml');
      thisstatus = thisstatus.slice(3);
      thisstatus = thisstatus.slice(0, -4);
